...
const pluginUrl='https://borismoniac.github.io/360.ProjectFiles/';
...
<head>
  ...
  <title>НашеПО · Создание проекта для Топоматик 360</title>
  <style>
...
<body><main>
  ...
  <h1>НашеПО · Создание проекта</h1>
  <p>Плагин открывает сразу несколько файлов в одном проекте Топоматик 360. Первый файл становится проектом, остальные подключаются к нему вложениями на отдельных слоях.</p>
  ...
  <div class="buttons"><a class="button" href="${installUrl}">Открыть установку в веб-версии</a><a class="button secondary" href="https://github.com/BorisMoniac/360.ProjectFiles">Исходный код</a></div>
  <ol><li>Откройте в настольном Топоматик 360 раздел <b>Плагины</b>.</li><li>Выберите <b>Установить плагин</b>.</li><li>Скопируйте адрес выше, вставьте его в поле и подтвердите установку.</li><li>После первой установки перезапустите приложение. В веб-версии обновите страницу Топоматик 360.</li><li>Откройте на ленте вкладку <b>НашеПО</b> и нажмите <b>Создать проект</b>.</li></ol>
